  ...
  return (
    <li
      className={`p-2 rounded-lg   hover:scale-105 ${
        props.entry.current
          ? "bg-orange-400 text-stone-100  shadow-lg shadow-orange-300"
          : "text-black border border-stone-400 "
      }`}
    >
      <Link to={props.entry.to} className="flex items-center">
        <svg
          stroke="currentColor"
          fill="currentColor"
          viewBox="0 0 512 512"
        ...
        <p
          className={`text-lg ml-3 ${
            props.entry.current ? "font-bold" : "font-normal"
          }`}
        >
          {props.entry.name}
        </p>
